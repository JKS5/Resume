...
/**Animation on scrolling:Bottom to Top */
function reveal() {
...
/**Animation on scrolling:Top to Bottom  */
function reveal_top() {
...
/**
  Animation on Scrolling:Left to right
 */
...
/**
  Animation on Scrolling:Right to Left
 */
...
/**
  Animation on Scrolling: from nothing to reveal from the Zero Point 
 */
function reveal_zero() {
  var reveals = document.querySelectorAll(".reveal_zero");
  for (var i = 0; i < reveals.length; i++) {
    var windowHeight = window.innerHeight;
    var elementTop = reveals[i].getBoundingClientRect().top;
    var elementVisible = -50;
...
window.addEventListener("scroll", reveal_zero);
      ...
      <div className=" w-full ">
        ...
        <div className="m-auto mx-auto flex flex-wrap">
          <div className="flex items-center justify-center w-1/2  ">
            <img className="reveal_left" src={dp}></img>
          </div>
          <div className="animate-fade-in-delay text-white  w-1/3 flex flex-col h-full  ">
            <div className="justify-center ">
              <div className="text-3xl reveal font-bold font_Jua">
                소통하는 개발자
              </div>
              ...
              <div className="mt-5 text-3xl reveal font-bold font_Jua">
                성장하는 개발자
              </div>
              <div className="mt-2 reveal">
